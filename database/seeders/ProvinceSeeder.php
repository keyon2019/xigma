...
class ProvinceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        INSERT INTO `provinces` (`id`,`name`,`latitude`,`longitude`) VALUES
                (1, 'آذربایجان شرقی', '37.90357330', '46.26821090'),
                (2, 'آذربایجان غربی', '37.45500620', '45.00000000'),
                (3, 'اردبیل', '38.48532760', '47.89112090'),
                (4, 'اصفهان', '32.65462750', '51.66798260'),
                (5, 'البرز', '35.99604670', '50.92892460'),
                (6, 'ایلام', '33.29576180', '46.67053400'),
                (7, 'بوشهر', '28.92338370', '50.82031400'),
                (8, 'تهران', '35.69611100', '51.42305600'),
                (9, 'چهارمحال و بختیاری', '31.96143480', '50.84563230'),
                (10, 'خراسان جنوبی', '32.51756430', '59.10417580'),
                (11, 'خراسان رضوی', '35.10202530', '59.10417580'),
                (12, 'خراسان شمالی', '37.47103530', '57.10131880'),
                (13, 'خوزستان', '31.43601490', '49.04131200'),
                (14, 'زنجان', '36.50181850', '48.39881860'),
                (15, 'سمنان', '35.22555850', '54.43421380'),
                (16, 'سیستان و بلوچستان', '27.52999060', '60.58206760'),
                (17, 'فارس', '29.10438130', '53.04589300'),
                (18, 'قزوین', '36.08813170', '49.85472660'),
                (19, 'قم', '34.63994430', '50.87594190'),
                (20, 'كردستان', '35.95535790', '47.13621250'),
                (21, 'كرمان', '30.28393790', '57.08336280'),
                (22, 'كرمانشاه', '34.31416700', '47.06500000'),
                (23, 'کهگیلویه و بویراحمد', '30.65094790', '51.60525000'),
                (24, 'گلستان', '37.28981230', '55.13758340'),
                (25, 'گیلان', '37.11716170', '49.52799960'),
                (26, 'لرستان', '33.58183940', '48.39881860'),
                (27, 'مازندران', '36.22623930', '52.53186040'),
                (28, 'مركزی', '33.50932940', '-92.39611900'),
                (29, 'هرمزگان', '27.13872300', '55.13758340'),
                (30, 'همدان', '34.76079990', '48.39881860'),
    (31, 'یزد', '32.10063870', '54.43421380');        
        ");

        DB::unprepared("
        INSERT INTO `cities` (`id`, `province_id`, `name`, `latitude`, `longitude`) VALUES
...
(439, 8, 'قرچک', '35.44', '51.57'),
(467, 8, 'گلستان', '35.51' ,'51.16'),
(468, 8, 'قدس', '35.72' ,'51.11'),
(440, 8, 'ملارد', '35.6656' ,'50.9781'),
(441, 8, 'نسیم‌شهر', '35.5500' ,'51.1667'),
(442, 8, 'اندیشه', '35.68333' ,'51.01666'),
(443, 8, 'صالح‌آباد', '35.5167' ,'51.1833'),
(444, 8, 'باقرشهر', '35.5092' ,'51.4022'),
(445, 8, 'باغستان', '35.6383' ,'51.1122'),
(446, 8, 'بومهن', '35.7319' ,'51.8647'),
(447, 8, 'چهاردانگه', '35.8369' ,'50.8467'),
(448, 8, 'پیشوا', '35.60' ,'51.90'),
(449, 8, 'پردیس', '35.7319' ,'51.8647'),
(450, 8, 'وحیدیه', '35.5964' ,'51.0414'),
(451, 8, 'نصیرآباد', '35.4953' ,'51.1369'),
(452, 8, 'فردوسیه', '35.6000' ,'51.0667'),
(453, 8, 'حسن‌آباد', '35.3675', '51.236944'),
(454, 8, 'رودهن', '35.7389' ,'51.9119'),
(455, 8, 'شاهدشهر', '35.5714' ,'51.0839'),
(456, 8, 'صباشهر', '35.5833' ,'51.1167'),
(457, 8, 'صفادشت', '35.684489' ,'50.824658'),
(458, 8, 'لواسان', '35.8243' ,'51.6336'),
(459, 8, 'آبسرد', '35.650661' ,'52.013761'),
(460, 8, 'شریف‌آباد', '35.4275' ,'51.7853'),
(461, 8, 'کهریزک', '35.515972' ,'51.362211'),
(462, 8, 'فشم', '35.9308' ,'51.5261'),
(463, 8, 'جوادآباد', NULL, NULL),
(464, 8, 'کیلان', '35.5536' ,'52.1633'),
(465, 8, 'آبعلی', '35.7631' ,'51.9656'),
(466, 8, 'ارجمند', '35.8158' ,'52.5167');
        ");
