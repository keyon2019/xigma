<template>
    <div class="uk-inline auto-input uk-width-1-1">
        ...
        <div v-show="records && records.length > 0" ref="drop"
             data-uk-dropdown="offset:2;pos:bottom-justify;boundary:.auto-input;boundary-align:true"
        ...
        fetch() {
            ...
            if (this.method === 'get') {
                ...
                if (this.additionalData) {
                    _.forEach(this.additionalData, (value, key) => {
