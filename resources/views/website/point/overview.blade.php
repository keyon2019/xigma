...
@section('profile-content')
    ...
    <ul uk-tab>
        <li><a href="#">از امتیازهات استفاده کن</a></li>
        <li><a href="#">مشاهده سوابق</a></li>
    </ul>

    <ul class="uk-switcher uk-margin">
        <li>
            <div class="uk-grid uk-grid-match uk-grid-small uk-child-width-1-4@m uk-child-width-1-2" data-uk-grid>
                ...
                <div class="uk-flex uk-flex-column">
                    ...
                    <button disabled class="uk-width-expand uk-margin-small-top uk-button uk-button-primary uk-border-rounded">
                        دریافت
                        جایزه
                    </button>
                </div>
