            ...
            <div class="uk-grid uk-grid-small uk-flex uk-flex-stretch">
                <div class="uk-width-3-4@m uk-flex uk-flex-middle">
                    <span style="margin-left: 1px"
                          class="uk-flex uk-background-muted-darker uk-height-1-1 uk-padding-small uk-padding-remove-vertical clickable" onclick="window.location.replace('/cart')"
                          data-uk-icon="icon:cart;ratio:1.5"></span>
                    <span class="uk-flex uk-background-muted-darker uk-height-1-1 uk-padding-small uk-padding-remove-vertical clickable" onclick="window.location.replace('/profile')"
...
<header class="@if($isHome ?? false) uk-position-absolute uk-position-top-center uk-background-muted @endif uk-margin-small-bottom"
        style="z-index: 10">
    <div class="nav">
            ...
            <div class="uk-grid uk-grid-collapse">
                <div class="uk-width-3-4@m uk-flex uk-flex-column">
                    <div class="uk-flex uk-flex-middle uk-flex-row" style="flex: 0.6 1 0px">
                        <span class="uk-flex uk-background-muted-darker uk-height-1-1 uk-padding-small uk-padding-remove-vertical clickable" onclick="window.location.replace('/cart')"
                              data-uk-icon="icon:cart;ratio:1.5"></span>
                ...
                <div class="uk-width-1-4@m">
                    <div class="uk-background-primary uk-text-center">
                        <a class="uk-link-reset" href="/">
                            <img uk-img width="90%" src="/uploads/xigma_logo.png" class="uk-padding uk-padding-remove-vertical">
                        </a>
                    </div>
                </div>
