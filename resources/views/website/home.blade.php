...
@section('content')
    ...
    <div class="uk-section uk-section-muted uk-position-relative uk-overflow-hidden">
        ...
        <div class="uk-container">
            ...
            <div class="uk-grid uk-grid-small uk-child-width-1-4 uk-grid-match uk-margin-large-top" data-uk-grid>
                @foreach(\App\Models\Category::whereFeatured(true)->limit(8)->get() as $category)
                    <div>
                        ...
                        <div class="uk-margin-small-top uk-text-small uk-text-center uk-text-truncate">{{$category->name}}</div>
                    </div>
                @endforeach
            </div>
        </div>
